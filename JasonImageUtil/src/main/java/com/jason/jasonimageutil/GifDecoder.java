...
public class GifDecoder {
    ...
    public Frame next() {
        if (isShow == false) {
            ...
            if (status == STATUS_PARSING) {
                if (currentFrame.getFrame() != null)
                    currentFrame = currentFrame.getFrame();
                // currentFrame = gifFrame;
            } else {
                currentFrame = currentFrame.getFrame();
    ...
    private void readImage() {
        ...
        if (gifFrame == null) {
            ...
            Frame f = gifFrame;
            while (f.getFrame() != null) {
                f = f.getFrame();
            }
            f.setFrame(new Frame(image, delay, widthLimit));
        }
